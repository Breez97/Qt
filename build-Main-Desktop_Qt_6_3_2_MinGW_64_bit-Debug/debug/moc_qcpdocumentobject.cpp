...
#include <memory>
#include "../../Main/qcpdocumentobject.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QCPDocumentObject_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QCPDocumentObject_t qt_meta_stringdata_QCPDocumentObject = {
    {
        QT_MOC_LITERAL(0, 17)   // "QCPDocumentObject"
    },
    "QCPDocumentObject"
};
...
const QMetaObject QCPDocumentObject::staticMetaObject = { {
    ...
    qt_meta_stringdata_QCPDocumentObject.offsetsAndSizes,
    qt_meta_data_QCPDocumentObject,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QCPDocumentObject_t
, QtPrivate::TypeAndForceComplete<QCPDocumentObject, std::true_type>
...
void *QCPDocumentObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QCPDocumentObject.stringdata0))
